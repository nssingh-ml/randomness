from tkinter import Button, Canvas, Checkbutton, DISABLED, Entry, Frame, IntVar, Label, LabelFrame, StringVar, OptionMenu, Scrollbar
...
class ScrollLabelFrame(LabelFrame):
    def __init__(self, parent, label):
        ...
        self._canvas_window = self._canvas.create_window((4, 4), window=self.inner_frame, anchor="nw")
