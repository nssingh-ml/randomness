...
class Main(Frame):
    ...
    def init_window(self):
        ...
        self._operm5 = TestItem(self.test_label_frame, self._test_type[11], 620, 160, p_value_x_coor=265, p_value_width=235, result_x_coor=505, result_width=110, font_size=11)
