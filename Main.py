...
def run_nist_gui(parent, on_close):
    ...
    nist_window = tk.Toplevel(parent)
    nist_window.resizable(0, 0)
    nist_window.geometry("1300x650")
    # root.title('Test Suite for NIST Random Numbers')
    exit = CustomButton(nist_window, 'Back', 695, 615, 100, on_back)
    ...
    nist_window.transient(parent)
    nist_window.grab_set()
    # parent.wait_window(nist_window)
    app = Main(nist_window)
    # app.focus_displayof()
